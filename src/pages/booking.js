...
import { Container, Row, Col, Button, Card, Carousel,Nav,Form } from "react-bootstrap";
...
<Container fluid>
                                        ...
                                        <Container fluid className="pt-5 pb-5">
                                            <Row>
                                                <Col className="pt-5 pb-5">
                                                    <br />
                                                    <h2 className="sectionMainHeading">Talent Booking</h2>
                                                    <p className="mt-5">After 4 years in the digital space, we have built up an impressive roster of over  2,000 celebrity & influencer connections. Whether you need Floyd Mayweather for a speaking event or Kat Graham for a social media promotion, we can have the contacts to make it happen.</p>
    ...
    <section>
        <Container fluid className="mt-5 mb-5">
            <Row>
                <Col className="p-0">
                    <Container fluid className="pt-5 pb-5 talentContantArea position-relative">
                        <Row>
                            <Col>
                                <Container className="h-100">
                                    <h2 className="mb-5 text-start text-primary">Celebrities Collaborated With</h2>
                                    <Row className="zigZagImg">
                                        <Col sm={6} md={4} lg={2}>
                                            <figure>
                                                <img src={CeleImg01} className="img-fluid"/>
                                                <p className="mb-1 fs-20">Amber Rose</p>
                                                <a href="https://www.instagram.com/amberrose/" className="text-primary fs-16 text-decoration-none" target="_blank">@amberrose</a> 
                                            </figure>
                                        </Col>
                                        ...
                                        <Col sm={6} md={4} lg={2} className="align-self-end">
                                            <figure className="align-self-end">
                                                ...
                                                <a href="https://www.instagram.com/candiceking/?hl=en" className="text-primary fs-16 text-decoration-none" target="_blank">@candiceking</a> 
                                            </figure>
                                        </Col>
                                        ...
                                        <Col sm={6} md={4} lg={2}>
                                            <figure>
                                                ...
                                                <a href="https://www.instagram.com/daniellecohn/?hl=en" className="text-primary fs-16 text-decoration-none" target="_blank">@daniellecohn</a> 
                                            </figure>
                                        </Col>
                                        ...
                                        <Col sm={6} md={4} lg={2} className="align-self-end">
                                            <figure className="align-self-end">
                                                ...
                                                <a href="https://www.instagram.com/floydmayweather/?hl=en" className="text-primary fs-16 text-decoration-none" target="_blank">@floydmayweather</a> 
                                            </figure>
                                        </Col>
                                        ...
                                        <Col sm={6} md={4} lg={2}>
                                            <figure>
                                                ...
                                                <a href="https://www.instagram.com/georginagio/?hl=en" className="text-primary fs-16 text-decoration-none" target="_blank">@georginagio</a> 
                                            </figure>
                                        </Col>
                                        ...
                                        <Col sm={6} md={4} lg={2} className="align-self-end">
                                            <figure className="align-self-end">
                                                ...
                                                <a href="https://www.instagram.com/thenewclassic/?hl=en" className="text-primary fs-16 text-decoration-none" target="_blank">@thenewclassic</a> 
                                            </figure>
                                        </Col>
                                    </Row>
                                    <Row className="zigZagImg">
                                        <Col sm={6} md={4} lg={2}>
                                            <figure>
                                                ...
                                                <a href="https://www.instagram.com/katgraham/" className="text-primary fs-16 text-decoration-none" target="_blank">@katgraham</a>
                                            </figure>
                                        </Col>
                                        ...
                                        <Col sm={6} md={4} lg={2} className="align-self-end">
                                            <figure className="align-self-end">
                                                ...
                                                <a href="https://www.instagram.com/noahschnapp/?hl=en" className="text-primary fs-16 text-decoration-none" target="_blank">@noahschnapp</a>
                                            </figure>
                                        </Col>
                                        ...
                                        <Col sm={6} md={4} lg={2}>
                                            <figure>
                                                ...
                                                <a href="https://www.instagram.com/bhadbhabie/?hl=en" className="text-primary fs-16 text-decoration-none" target="_blank">@bhadbhabie</a>
                                            </figure>
                                        </Col>
                                        ...
                                        <Col sm={6} md={4} lg={2} className="align-self-end">
                                            <figure className="align-self-end">
                                                ...
                                                <a href="https://www.instagram.com/realbarbarapalvin/?hl=en" className="text-primary fs-16 text-decoration-none" target="_blank">@realbarbarapalvin</a>
                                            </figure>
                                        </Col>
                                        ...
                                        <Col sm={6} md={4} lg={2}>
                                            <figure>
                                                ...
                                                <a href="https://www.instagram.com/nikitadragun/?hl=en" className="text-primary fs-16 text-decoration-none" target="_blank">@nikitadragun</a>
                                            </figure>
                                        </Col>
                                        ...
                                        <Col sm={6} md={4} lg={2} className="align-self-end">
                                            <figure className="align-self-end">
                                                ...
                                                <a href="https://www.instagram.com/kristenhanby/?hl=en" className="text-primary fs-16 text-decoration-none" target="_blank">@kristenhanby</a>
                                            </figure>
                                        </Col>
                                    </Row>
